...
export type GetAllPhotosQuery = { __typename?: 'Query', getAllPhotos: Array<{ __typename?: 'Photo', id: number, imageFileId?: number | null, userId: number, yearId: number, year: { __typename?: 'Year', year: string }, user: { __typename?: 'User', firstName: string, lastName: string }, image: { __typename?: 'File', uri: string } }> };

export type SavePhotoMutationVariables = Exact<{
  dto: SavePhotoDto;
}>;


export type SavePhotoMutation = { __typename?: 'Mutation', savePhoto: { __typename?: 'Photo', id: number } };

export type GetAllScoresCurrentQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllScoresCurrentQuery = { __typename?: 'Query', getAllScoresCurrent: Array<{ __typename?: 'Score', id: number, aperitif: number, dessert: number, entreeChaude: number, entreeFroide: number, plat: number, sorbet: number, soupe: number, user: { __typename?: 'User', id: number, firstName: string, login: string }, year: { __typename?: 'Year', id: number, year: string } }> };
...
export function useGetAllPhotosSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllPhotosQuery, GetAllPhotosQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export const SavePhotoDocument = gql`
    mutation savePhoto($dto: SavePhotoDto!) {
  savePhoto(dto: $dto) {
    id
  }
}
    `;
export type SavePhotoMutationFn = Apollo.MutationFunction<SavePhotoMutation, SavePhotoMutationVariables>;
 ...
 * });
 */
export function useSavePhotoMutation(baseOptions?: Apollo.MutationHookOptions<SavePhotoMutation, SavePhotoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SavePhotoMutation, SavePhotoMutationVariables>(SavePhotoDocument, options);
      }
export type SavePhotoMutationHookResult = ReturnType<typeof useSavePhotoMutation>;
export type SavePhotoMutationResult = Apollo.MutationResult<SavePhotoMutation>;
export type SavePhotoMutationOptions = Apollo.BaseMutationOptions<SavePhotoMutation, SavePhotoMutationVariables>;
